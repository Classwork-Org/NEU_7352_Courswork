...
# mark_description "-O2 -S -fverbose-asm -o ../asm/drystone.icc.opt2.asm";
	.file "drystone.c"
	.text
..TXTST0:
...
..B1.6:                         # Preds ..B1.5
        ...
        movq      120(%rsp), %rax                               #135.7
        xorl      %edx, %edx                                    #135.7
        movq      %rax, 112(%rsp)                               #135.7[spill]
        movq      $0x20444e2732202c4d, %r9                      #135.7
        movq      PtrGlb(%rip), %rax                            #135.7
        movq      %r12, 72(%rsp)                                #135.7[spill]
        movq      %r13, 80(%rsp)                                #135.7[spill]
        movl      $7, %r8d                                      #135.7
        movq      %r14, 88(%rsp)                                #135.7[spill]
        movl      $8, %ecx                                      #135.7
        movq      %r15, 96(%rsp)                                #135.7[spill]
        movq      %rbx, 104(%rsp)                               #135.7[spill]
	.cfi_escape 0x10, 0x03, 0x0e, 0x38, 0x1c, 0x0d, 0x80, 0xff, 0xff, 0xff, 0x1a, 0x0d, 0x68, 0xff, 0xff, 0xff, 0x22
	.cfi_escape 0x10, 0x0c, 0x0e, 0x38, 0x1c, 0x0d, 0x80, 0xff, 0xff, 0xff, 0x1a, 0x0d, 0x48, 0xff, 0xff, 0xff, 0x22
	.cfi_escape 0x10, 0x0d, 0x0e, 0x38, 0x1c, 0x0d, 0x80, 0xff, 0xff, 0xff, 0x1a, 0x0d, 0x50, 0xff, 0xff, 0xff, 0x22
	.cfi_escape 0x10, 0x0e, 0x0e, 0x38, 0x1c, 0x0d, 0x80, 0xff, 0xff, 0xff, 0x1a, 0x0d, 0x58, 0xff, 0xff, 0xff, 0x22
	.cfi_escape 0x10, 0x0f, 0x0e, 0x38, 0x1c, 0x0d, 0x80, 0xff, 0xff, 0xff, 0x1a, 0x0d, 0x60, 0xff, 0xff, 0xff, 0x22
        movq      %rax, %rbx                                    #135.7
        movl      %edx, %r14d                                   #135.7
        movl      $18254, %r13d                                 #135.7
        movq      $0x4152474f52502045, %r12                     #135.7
        movq      $0x4e4f545359524844, %r15                     #135.7
                                # LOE rbx r9 r12 r15 ecx r8d r13d r14d
..B1.7:                         # Preds ..B1.30 ..B1.6
                                # Execution count [0.00e+00]
        ...
        lea       (%rsp), %rdi                                  #135.7
        movq      %r15, (%rdi)                                  #135.7
        movq      %r12, 8(%rdi)                                 #135.7
        movq      %r9, 16(%rdi)                                 #135.7
        movl      $1230132307, 24(%rdi)                         #135.7
        movw      %r13w, 28(%rdi)                               #135.7
        movb      $0, 30(%rdi)                                  #135.7
                                # LOE rbx rsi r9 r12 r15 eax edx ecx r8d r13d r14d
..B1.8:                         # Preds ..B1.8 ..B1.7
                                # Execution count [0.00e+00]
        movb      31(%rsp,%rsi), %dil                           #135.7
        lea       1(%rsi), %r11                                 #135.7
        movb      1(%rsp,%rsi), %r10b                           #135.7
        cmpb      %r10b, %dil                                   #135.7
        cmovne    %r11, %rsi                                    #135.7
        cmovne    %edx, %eax                                    #135.7
        cmpq      $1, %rsi                                      #135.7
        jle       ..B1.8        # Prob 0%                       #135.7
                                # LOE rbx rsi r9 r12 r15 eax edx ecx r8d r13d r14d
..B1.9:                         # Preds ..B1.8
                                # Execution count [0.00e+00]
        cmpb      $88, %al                                      #135.7
        je        ..B1.11       # Prob 6%                       #135.7
                                # LOE rbx r9 r12 r15 ecx r8d r13d r14d
..B1.10:                        # Preds ..B1.9
                                # Execution count [0.00e+00]
        movl      $0, BoolGlob(%rip)                            #135.7
        lea       31(%rsp), %rdi                                #135.7
        lea       (%rsp), %rsi                                  #135.7
..L22:                                                          #135.7
        movb      (%rdi), %dl                                   #135.7
        cmpb      (%rsi), %dl                                   #135.7
...
..L24:                                                          #
        ...
        orl       $1, %eax                                      #135.7
..L25:                                                          #
                                # LOE rbx r9 r12 r15 eax ecx r8d r13d r14d
..B1.40:                        # Preds ..B1.10
                                # Execution count [0.00e+00]
        testl     %eax, %eax                                    #135.7
        jle       ..B1.12       # Prob 16%                      #135.7
                                # LOE rbx r9 r12 r15 ecx r8d r13d r14d
..B1.11:                        # Preds ..B1.9 ..B1.40
                                # Execution count [0.00e+00]
        movl      $0, BoolGlob(%rip)                            #135.7
        jmp       ..B1.13       # Prob 100%                     #135.7
                                # LOE rbx r9 r12 r15 ecx r8d r13d r14d
..B1.12:                        # Preds ..B1.40
                                # Execution count [0.00e+00]
...
..B1.13:                        # Preds ..B1.12 ..B1.11
                                # Execution count [0.00e+00]
        movq      (%rbx), %rdi                                  #135.7
        movups    (%rbx), %xmm0                                 #135.7
        movups    %xmm0, (%rdi)                                 #135.7
        lea       32+Array1Glob(%rip), %rax                     #135.7
        movl      %r8d, (%rax)                                  #135.7
        movups    16(%rbx), %xmm1                               #135.7
        movups    %xmm1, 16(%rdi)                               #135.7
        movl      %r8d, 4(%rax)                                 #135.7
        movups    32(%rbx), %xmm2                               #135.7
        movups    %xmm2, 32(%rdi)                               #135.7
        movl      %ecx, 120(%rax)                               #135.7
        movq      48(%rbx), %rsi                                #135.7
        movq      %rsi, 48(%rdi)                                #135.7
        movl      $5, %esi                                      #135.7
        movq      (%rbx), %r10                                  #135.7
        lea       1660+Array2Glob(%rip), %rdi                   #135.7
        incl      (%rdi)                                        #135.7
        movl      %ecx, 4(%rdi)                                 #135.7
        movl      %esi, 16(%r10)                                #135.7
        movq      (%rbx), %r11                                  #135.7
        movl      %ecx, 8(%rdi)                                 #135.7
        movq      %r11, (%r11)                                  #135.7
        movq      (%rbx), %rdi                                  #135.7
        movl      %r8d, 5744+Array2Glob(%rip)                   #135.7
        movl      %esi, IntGlob(%rip)                           #135.7
        movq      (%rdi), %r10                                  #135.7
        movl      $17, 16(%rbx)                                 #135.7
        movq      %rdi, (%r10)                                  #135.7
        movq      (%rbx), %rdi                                  #135.7
        cmpl      $0, 8(%rdi)                                   #135.7
        je        ..B1.15       # Prob 22%                      #135.7
                                # LOE rbx rdi r9 r12 r15 ecx r8d r13d r14d
..B1.14:                        # Preds ..B1.13
                                # Execution count [0.00e+00]
        movups    (%rdi), %xmm0                                 #135.7
        movups    %xmm0, (%rbx)                                 #135.7
        movups    16(%rdi), %xmm1                               #135.7
        movups    %xmm1, 16(%rbx)                               #135.7
        movups    32(%rdi), %xmm2                               #135.7
        movups    %xmm2, 32(%rbx)                               #135.7
        movq      48(%rdi), %rsi                                #135.7
        movq      %rsi, 48(%rbx)                                #135.7
        jmp       ..B1.30       # Prob 100%                     #135.7
                                # LOE rbx r9 r12 r15 ecx r8d r13d r14d
..B1.15:                        # Preds ..B1.13
                                # Execution count [0.00e+00]
        movl      12(%rbx), %esi                                #135.7
        movl      $6, 16(%rdi)                                  #135.7
        cmpl      $2, %esi                                      #135.7
        je        ..B1.17       # Prob 50%                      #135.7
                                # LOE rbx rsi rdi r9 r12 r15 ecx r8d r13d r14d
..B1.16:                        # Preds ..B1.15
                                # Execution count [0.00e+00]
        movl      $3, 12(%rdi)                                  #135.7
        cmpl      $4, %esi                                      #135.7
        jbe       ..B1.18       # Prob 50%                      #135.7
        jmp       ..B1.29       # Prob 100%                     #135.7
                                # LOE rbx rsi rdi r9 r12 r15 ecx r8d r13d r14d
..B1.17:                        # Preds ..B1.15
                                # Execution count [0.00e+00]
        movl      %esi, 12(%rdi)                                #135.7
                                # LOE rbx rsi rdi r9 r12 r15 ecx r8d r13d r14d
..B1.18:                        # Preds ..B1.16 ..B1.17
                                # Execution count [0.00e+00]
        jmp       *.2.27_2.switchtab.58(,%rsi,8)                #135.7
                                # LOE rbx rdi r9 r12 r15 ecx r8d r13d r14d
..1.8_0.TAG.4.0.8.51:
..B1.20:                        # Preds ..B1.18
                                # Execution count [0.00e+00]
...
..B1.28:                        # Preds ..B1.18
        ...
        movl      $0, 12(%rdi)                                  #135.7
                                # LOE rbx rdi r9 r12 r15 ecx r8d r13d r14d
..1.8_0.TAG.3.0.8.51:
..B1.29:                        # Preds ..B1.18 ..B1.16 ..B1.28 ..B1.26 ..B1.24
                                #       ..B1.20
                                # Execution count [0.00e+00]
        movq      %rdi, (%rdi)                                  #135.7
        movq      (%rbx), %rsi                                  #135.7
        addl      $12, 16(%rsi)                                 #135.7
                                # LOE rbx r9 r12 r15 ecx r8d r13d r14d
..B1.30:                        # Preds ..B1.29 ..B1.14
                                # Execution count [0.00e+00]
        incl      %r14d                                         #135.7
...
..L52:
	...
	.cfi_def_cfa_offset 176
        lea       128(%rsp), %rdi                               #176.8
#       times(struct tms *)
        call      times                                         #176.8
                                # LOE rbx rbp r12 r13 r14 r15
..B2.2:                         # Preds ..B2.1
                                # Execution count [0.00e+00]
        lea       128(%rsp), %rdx                               #176.33
        movq      (%rdx), %rax                                  #176.33
        lea       (%rdx), %rdi                                  #178.8
...
..B2.6:                         # Preds ..B2.5
                                # Execution count [0.00e+00]
        movq      128(%rsp), %rax                               #197.33
        xorl      %edi, %edi                                    #199.6
        movq      %rax, 120(%rsp)                               #197.33[spill]
        movq      $0x20444e2732202c4d, %rdx                     #206.8
        xorl      %eax, %eax                                    #208.21
        incq      %rax                                          #208.21
        movq      PtrGlb(%rip), %rsi                            #216.14
        movl      $7, %r9d                                      #215.8
        movq      %r12, 72(%rsp)                                #216.8[spill]
        movl      $8, %r8d                                      #215.8
        movq      %r13, 80(%rsp)                                #216.8[spill]
        movl      $5, %ecx                                      #216.8
        movq      %r14, 88(%rsp)                                #216.8[spill]
	.cfi_offset 12, -104
	.cfi_offset 13, -96
	.cfi_offset 14, -88
        movq      %rsi, %r14                                    #216.8
        movq      %r15, 96(%rsp)                                #216.8[spill]
	.cfi_offset 15, -80
        movq      %rdx, %r15                                    #216.8
        movq      %rbx, 104(%rsp)                               #216.8[spill]
	.cfi_offset 3, -72
        movq      %rax, %rbx                                    #216.8
        movq      %rbp, 112(%rsp)                               #216.8[spill]
	.cfi_offset 6, -64
        movl      %edi, %r13d                                   #216.8
        movl      $18254, %r12d                                 #216.8
        movq      $0x4e4f545359524844, %rbp                     #216.8
                                # LOE rbx rbp r14 r15 ecx r8d r9d r12d r13d
..B2.7:                         # Preds ..B2.30 ..B2.6
                                # Execution count [0.00e+00]
        movq      $0x4152474f52502045, %r10                     #206.8
        movl      $65, %edi                                     #208.21
        movb      $65, Char1Glob(%rip)                          #202.8
        movb      $66, Char2Glob(%rip)                          #203.8
        lea       (%rsp), %rax                                  #206.8
        movq      %rbp, (%rax)                                  #206.8
        movq      %r10, 8(%rax)                                 #206.8
        movq      %rbx, %r10                                    #208.21
        movq      %r15, 16(%rax)                                #206.8
        movl      $1230132307, 24(%rax)                         #206.8
        movw      %r12w, 28(%rax)                               #206.8
        movb      $0, 30(%rax)                                  #206.15
                                # LOE rbx rbp r10 r14 r15 ecx edi r8d r9d r11d r12d r13d
..B2.8:                         # Preds ..B2.8 ..B2.7
                                # Execution count [0.00e+00]
        movb      31(%rsp,%r10), %al                            #208.27
        lea       1(%r10), %rsi                                 #208.21
        movb      1(%rsp,%r10), %dl                             #208.39
        cmpb      %dl, %al                                      #208.21
        cmovne    %rsi, %r10                                    #208.21
        cmovne    %edi, %r11d                                   #208.21
        cmpq      $1, %r10                                      #208.21
        jle       ..B2.8        # Prob 0%                       #208.21
                                # LOE rbx rbp r10 r14 r15 ecx edi r8d r9d r11d r12d r13d
..B2.9:                         # Preds ..B2.8
                                # Execution count [0.00e+00]
        cmpb      $88, %r11b                                    #208.21
        je        ..B2.11       # Prob 6%                       #208.21
                                # LOE rbx rbp r14 r15 ecx r8d r9d r12d r13d
..B2.10:                        # Preds ..B2.9
                                # Execution count [0.00e+00]
        movl      $0, BoolGlob(%rip)                            #202.8
        lea       31(%rsp), %rdi                                #208.21
        lea       (%rsp), %rsi                                  #208.21
..L72:                                                          #208.21
        movb      (%rdi), %dl                                   #208.21
        cmpb      (%rsi), %dl                                   #208.21
        jne       ..L74         # Prob 50%                      #208.21
        testb     %dl, %dl                                      #208.21
        je        ..L73         # Prob 50%                      #208.21
        ...
        addq      $2, %rsi                                      #208.21
        testb     %dl, %dl                                      #208.21
        jne       ..L72         # Prob 50%                      #208.21
..L73:                                                          #
        xorl      %eax, %eax                                    #208.21
        jmp       ..L75         # Prob 100%                     #208.21
..L74:                                                          #
        sbbl      %eax, %eax                                    #208.21
        orl       $1, %eax                                      #208.21
..L75:                                                          #
                                # LOE rbx rbp r14 r15 eax ecx r8d r9d r12d r13d
..B2.39:                        # Preds ..B2.10
                                # Execution count [0.00e+00]
        testl     %eax, %eax                                    #208.21
        jle       ..B2.12       # Prob 16%                      #208.21
                                # LOE rbx rbp r14 r15 ecx r8d r9d r12d r13d
..B2.11:                        # Preds ..B2.9 ..B2.39
                                # Execution count [0.00e+00]
        movl      $0, BoolGlob(%rip)                            #208.8
        jmp       ..B2.13       # Prob 100%                     #208.8
                                # LOE rbx rbp r14 r15 ecx r8d r9d r12d r13d
..B2.12:                        # Preds ..B2.39
                                # Execution count [0.00e+00]
...
..B2.13:                        # Preds ..B2.12 ..B2.11
        ...
        movups    %xmm0, (%r11)                                 #216.8
        lea       32+Array1Glob(%rip), %rdx                     #215.14
        movl      %r9d, (%rdx)                                  #215.14
        movups    16(%rax), %xmm1                               #216.8
        movups    %xmm1, 16(%r11)                               #216.8
        movl      %r9d, 4(%rdx)                                 #215.14
        movups    32(%rax), %xmm2                               #216.8
        movups    %xmm2, 32(%r11)                               #216.8
        movl      %r8d, 120(%rdx)                               #215.14
        movq      48(%rax), %r10                                #216.8
        movq      %r10, 48(%r11)                                #216.8
        movq      (%rax), %r10                                  #216.8
        lea       1660+Array2Glob(%rip), %r11                   #215.8
        incl      (%r11)                                        #215.8
        movl      %r8d, 4(%r11)                                 #215.8
        movl      %ecx, 16(%r10)                                #216.8
        movq      (%rax), %r10                                  #216.8
        movl      %r8d, 8(%r11)                                 #215.8
        movq      %r10, (%r10)                                  #216.8
        movq      (%rax), %r10                                  #216.8
        movl      %r9d, 5744+Array2Glob(%rip)                   #215.8
        movl      %ecx, IntGlob(%rip)                           #215.8
        movq      (%r10), %r11                                  #216.8
        movl      $17, 16(%rax)                                 #216.8
        movq      %r10, (%r11)                                  #216.8
        movq      (%rax), %r11                                  #216.8
        cmpl      $0, 8(%r11)                                   #216.8
        je        ..B2.15       # Prob 22%                      #216.8
                                # LOE rbx rbp r11 r14 r15 ecx r8d r9d r12d r13d
..B2.14:                        # Preds ..B2.13
                                # Execution count [0.00e+00]
        movups    (%r11), %xmm0                                 #216.8
        movups    %xmm0, (%r14)                                 #216.8
        movups    16(%r11), %xmm1                               #216.8
        movups    %xmm1, 16(%r14)                               #216.8
        movups    32(%r11), %xmm2                               #216.8
        movups    %xmm2, 32(%r14)                               #216.8
        movq      48(%r11), %r10                                #216.8
        movq      %r10, 48(%r14)                                #216.8
        jmp       ..B2.30       # Prob 100%                     #216.8
                                # LOE rbx rbp r14 r15 ecx r8d r9d r12d r13d
..B2.15:                        # Preds ..B2.13
                                # Execution count [0.00e+00]
        movl      12(%r14), %r10d                               #216.8
        movl      $6, 16(%r11)                                  #216.8
        cmpl      $2, %r10d                                     #216.8
        je        ..B2.17       # Prob 50%                      #216.8
                                # LOE rbx rbp r10 r11 r14 r15 ecx r8d r9d r12d r13d
..B2.16:                        # Preds ..B2.15
                                # Execution count [0.00e+00]
        movl      $3, 12(%r11)                                  #216.8
        cmpl      $4, %r10d                                     #216.8
        jbe       ..B2.18       # Prob 50%                      #216.8
        jmp       ..B2.29       # Prob 100%                     #216.8
                                # LOE rbx rbp r10 r11 r14 r15 ecx r8d r9d r12d r13d
..B2.17:                        # Preds ..B2.15
                                # Execution count [0.00e+00]
        movl      %r10d, 12(%r11)                               #216.8
                                # LOE rbx rbp r10 r11 r14 r15 ecx r8d r9d r12d r13d
..B2.18:                        # Preds ..B2.16 ..B2.17
                                # Execution count [0.00e+00]
        jmp       *.2.28_2.switchtab.56(,%r10,8)                #216.8
                                # LOE rbx rbp r11 r14 r15 ecx r8d r9d r12d r13d
..1.8_0.TAG.4.0.8.34:
..B2.20:                        # Preds ..B2.18
                                # Execution count [0.00e+00]
...
..B2.28:                        # Preds ..B2.18
        ...
        movl      $0, 12(%r11)                                  #216.8
                                # LOE rbx rbp r11 r14 r15 ecx r8d r9d r12d r13d
..1.8_0.TAG.3.0.8.34:
..B2.29:                        # Preds ..B2.18 ..B2.16 ..B2.28 ..B2.26 ..B2.24
                                #       ..B2.20
                                # Execution count [0.00e+00]
        movq      %r11, (%r11)                                  #216.8
        movq      (%r14), %r10                                  #216.8
        addl      $12, 16(%r10)                                 #216.8
                                # LOE rbx rbp r14 r15 ecx r8d r9d r12d r13d
..B2.30:                        # Preds ..B2.29 ..B2.14
                                # Execution count [0.00e+00]
        incl      %r13d                                         #199.26
        cmpl      $500000000, %r13d                             #199.17
...
..B2.32:                        # Preds ..B2.31
                                # Execution count [0.00e+00]
        movq      128(%rsp), %rcx                               #237.20
        movq      $0x8888888888888889, %rax                     #238.1
        subq      120(%rsp), %rcx                               #237.20[spill]
        ...
        sarq      $63, %rcx                                     #238.1
        subq      %rcx, %rdx                                    #238.1
..___tag_value_Proc0.96:
#       printf(const char *__restrict__, ...)
        call      printf                                        #238.1
..___tag_value_Proc0.97:
                                # LOE rbx rbp r12 r13 r14 r15
..B2.33:                        # Preds ..B2.32
                                # Execution count [0.00e+00]
...
..B12.2:                        # Preds ..B12.2 ..B12.1
                                # Execution count [1.00e+00]
        lea       1(%rdx), %r10                                 #392.26
        movb      (%rdx,%rdi), %r8b                             #389.26
        movb      1(%rdx,%rsi), %r9b                            #389.44
        cmpb      %r9b, %r8b                                    #391.24
        cmovne    %r10, %rdx                                    #392.26
        cmovne    %eax, %ecx                                    #391.24
        cmpq      $1, %rdx                                      #388.25
        jle       ..B12.2       # Prob 0%                       #388.25
                                # LOE rdx rbx rbp rsi rdi r12 r13 r14 r15 eax ecx
..B12.3:                        # Preds ..B12.2
                                # Execution count [1.00e+00]
        cmpb      $88, %cl                                      #396.23
        je        ..B12.5       # Prob 6%                       #396.23
...
..L132:                                                         #400.20
        movb      (%rdi), %dl                                   #400.20
        cmpb      (%rsi), %dl                                   #400.20
        jne       ..L134        # Prob 50%                      #400.20
        testb     %dl, %dl                                      #400.20
        je        ..L133        # Prob 50%                      #400.20
        ...
        addq      $2, %rsi                                      #400.20
        testb     %dl, %dl                                      #400.20
        jne       ..L132        # Prob 50%                      #400.20
..L133:                                                         #
        xorl      %eax, %eax                                    #400.20
        jmp       ..L135        # Prob 100%                     #400.20
..L134:                                                         #
        sbbl      %eax, %eax                                    #400.20
        orl       $1, %eax                                      #400.20
..L135:                                                         #
